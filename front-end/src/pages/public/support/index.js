              ...
              {isActive === "2" && (
                <div className="mt-5">
                  ...
                  <Accordion open={openAccordion === 2}>
                    ...
                    <AccordionBody className="text-gray-500">
                      ...
                      <p>
                        ...
                        khoản thành viên trước khi mua vé để hệ thống tích điểm
                        vào tài khoản thành viên của bạn.
                      </p>
                      <br></br>
                      <span className="text-red-500">Bước 2: </span>
                      <p>
                        Bạn vào mục Mua vé đối với Website/chọn Phim đang chiếu
                        đối với App, bạn chọn Rạp - chọn Phim - chọn Suất chiếu
                        - chọn Số lượng ghế tối đa 8 ghế cho một giao dịch/Combo
                        bắp nước - chọn Ghế - tiến hành thanh toán.
                      </p>
                      <br></br>
                      <span className="text-red-500">Bước 3: </span>
                      <p>
                        Tại bước thanh toán, bạn điền vào các thông tin đã được
                        cấp trước đó để test hệ thống. Sau đó bạn có thể tiến
                        hành thanh toán bằng nhiều hình thức.
                      </p>{" "}
                      <br></br>
                      <span className="text-red-500">Bước 4: </span>
                      <p>
                        Sau 5 phút bạn sẽ được đưa đến trang túi vé của bạn. Tại
                        có thể check lại thông tin và nhớ chụp mã QR để lấy vé
                        tại quầy.
                      </p>
                    </AccordionBody>
                  </Accordion>
                  <Accordion open={openAccordion === 3}>
                    ...
                    <AccordionBody className="text-gray-500">
                      <p>
                        Bạn có thể vào mục hỗ trợ tại webite bằng cách điền vào
                        các thông tin cá nhân và lỗi hay góp ý của bạn. Sau đó
                        nhấn gửi để hệ thống ghi nhận hoặc bạn có liên hệ thông
                        qua Email của hệ thống và hot line của trang.
                      </p>
                    </AccordionBody>
                  </Accordion>
                </div>
