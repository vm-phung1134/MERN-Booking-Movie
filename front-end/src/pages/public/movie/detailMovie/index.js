        ...
        <div className="bg-black max-h-full px-10 pt-10">
           <div className="grid grid-cols-4">
                ...
                <div className="col-span-3 px-5 text-white">
                    <button className="mb-1 py-[20px] border-b-2 border-[#E50914]">
                    ...
                    <button className="px-8 my-5 py-4 text-white bg-[#E51409]">
                        ĐẶT VÉ
                    </button>
                </div>
           </div>
            <div>
                <div className="pt-10">
                    <button className="mb-5 py-[20px] text-white border-b-2 border-[#E50914]">
                        NỘI DUNG PHIM
                    </button>
