...
function LoginForm() {
  ...
  const handleClickSubmit = (e) => {
      e.preventDefault();
      dispatch(authLogin(stateEmail, statePassword))
  }
    ...
    <>
      ...
      >
        <div className="w-[60%] p-4 m-auto bg-transparent rounded-md shadow-xl lg:max-w-xl">
          ...
          <p className="pt-1 text-center text-red-700">{stateErr}</p>
          <form className="mt-6" onSubmit={handleClickSubmit}>
            <div className="mb-2">
              <label
                htmlFor="email"
              ...
              <input
                ...
                required
                type="email"
                className="block w-full px-4 py-2 mt-2 text-white bg-transparent border 
                rounded-md focus:border-white focus:ring-white  focus:outline-none focus:ring "
              />
            </div>
            <div className="mb-2">
              <label
              ...
              <input
                ...
                required
                type="password"
                className="block w-full px-4 py-2 mt-2 text-white bg-transparent border rounded-md 
                focus:border-white focus:ring-white focus:outline-none focus:ring "
              />
            </div>
            ...
            <div className="mt-6">
              <button type="submit" className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200
              transform bg-red-700 rounded-md hover:bg-red-600 focus:outline-none focus:bg-red-600">
                Đăng nhập
              </button>
            </div>
          </form>
